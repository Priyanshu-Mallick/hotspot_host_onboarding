...
class AppColors {
  ...
  static Color text2 = Color(0xFFFFFFFF).withOpacity(0.72); // 72% opacity
  static Color text3 = Color(0xFFFFFFFF).withOpacity(0.48); // 48% opacity
  static Color text4 = Color(0xFFFFFFFF).withOpacity(0.24); // 24% opacity
  ...
  static Color surfaceWhite1 =
      Color(0xFFFFFFFF).withOpacity(0.02); // 2% opacity
  static Color surfaceWhite2 =
      Color(0xFFFFFFFF).withOpacity(0.06); // 6% opacity
  static Color surfaceBlack1 =
      Color(0xFF101010).withOpacity(0.90); // 90% opacity
  static Color surfaceBlack2 =
      Color(0xFF101010).withOpacity(0.70); // 70% opacity
  static Color surfaceBlack3 =
      Color(0xFF101010).withOpacity(0.50); // 50% opacity
  ...
  // Borders
  static Color border1 = Color(0xFFFFFFFF).withOpacity(0.08); // border 1
  static Color border2 = Color(0xFFFFFFFF).withOpacity(0.16); // border 2
  static Color border3 = Color(0xFFFFFFFF).withOpacity(0.24); // border 3
  ...
  static Color effectBgBlur12 =
      Color(0xFF101010).withOpacity(0.12); // background blur 12
  static Color effectBgBlur40 =
      Color(0xFF101010).withOpacity(0.40); // background blur 40
  static Color effectBgBlur80 =
      Color(0xFF141414).withOpacity(0.80); // background blur 80
}
