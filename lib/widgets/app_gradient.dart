...
class AppGradients {
  ...
  static RadialGradient radialGradientLight = RadialGradient(
    colors: [
      Color(0xFF222222).withOpacity(0.20), // #222222 at 20% opacity
      Color(0xFF999999).withOpacity(0.20), // #999999 at 20% opacity
      Color(0xFF222222).withOpacity(0.20), // #222222 at 20% opacity
    ],
    radius: 0.5,
  ...
  static RadialGradient radialGradientDark = RadialGradient(
    colors: [
      Color(0xFF222222).withOpacity(0.40), // #222222 at 40% opacity
      Color(0xFF999999).withOpacity(0.40), // #999999 at 40% opacity
      Color(0xFF222222).withOpacity(0.40), // #222222 at 40% opacity
    ],
    radius: 3,
    center: Alignment.topLeft, // Align the gradient to the center
  ...
  static LinearGradient topBorderGradient = LinearGradient(
    colors: [
      Color(0xFFFFFFFF).withOpacity(0.08), // White with 8% opacity
  ...
  static LinearGradient backgroundBlur = LinearGradient(
    colors: [
      Color(0x222222).withOpacity(0.40), // Darker background with 40% opacity
      Color(0x999999).withOpacity(0.40), // Grey with 40% opacity
      Color(0x222222).withOpacity(0.40), // Dark background with 40% opacity
    ],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  );
